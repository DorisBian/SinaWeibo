...
import com.bzy.weibo.ui.view.IUrlView;

/**
 */
public class UrlPresenter extends BasePresenter<IUrlView> {

    private Activity activity;

    public UrlPresenter(Activity activity) {
        this.activity = activity;
    }

    public void setWebView(String url){

        IUrlView urlView = getView();
