package com.bzy.weibo.ui.adapter;
...
import com.bzy.weibo.bean.Comments;
import com.bzy.weibo.bean.Favorite;
import com.bzy.weibo.bean.Photo;
import com.bzy.weibo.bean.Status;
import com.bzy.weibo.bean.User;
import com.bzy.weibo.ui.activity.CommentAndRepostActivity;
...
import com.bzy.weibo.util.ScreenUtil;
import com.bzy.weibo.util.StringUtil;
import com.bzy.weibo.widget.ClickCircleImageView;
import com.bzy.weibo.widget.ninegridlayout.NineGridlayout;
import com.bzy.weibo.widget.ninegridlayout.OneImage;
...
public class TopicListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TopicListAdapter(Context context, List list, String tag) {
